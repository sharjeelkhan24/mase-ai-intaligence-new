...
export default function StaffRecordsPage() {
  ...
  const recentUpdates = [
    { id: 1, staff: 'Sarah Johnson', update: 'Profile information updated', date: '2024-01-15', user: 'Sarah Johnson' },
    { id: 2, staff: 'Mike Chen', update: 'Emergency contact updated', date: '2024-01-14', user: 'Mike Chen' },
    { id: 3, staff: 'Emily Rodriguez', update: 'Certification renewed', date: '2024-01-13', user: 'HR System' },
    { id: 4, staff: 'David Wilson', update: 'Benefits enrollment completed', date: '2024-01-12', user: 'HR System' }
  ];
      ...
      <div className="flex-1 flex flex-col ml-64">
        <header className="bg-white shadow-sm border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 font-[family-name:var(--font-adlam-display)]">Staff Records</h1>
              <p className="text-gray-600 mt-1 font-[family-name:var(--font-adlam-display)]">Manage staff records and information</p>
            </div>
                  ...
                  {recentUpdates.map((update) => (
                    <div key={update.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h4 className="font-medium text-gray-900 font-[family-name:var(--font-adlam-display)]">{update.staff}</h4>
                          <p className="text-sm text-gray-500">{update.update}</p>
                          <p className="text-xs text-gray-400">By {update.user} • {new Date(update.date).toLocaleDateString()}</p>
                        </div>
                      </div>
                      <button className="text-blue-600 hover:text-blue-900">
                        <Eye className="w-4 h-4" />

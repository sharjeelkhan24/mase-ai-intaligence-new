...
export default function ReportsPage() {
  ...
  const reports = [
    { id: 1, name: 'Monthly HR Summary', type: 'HR Report', date: '2024-01-15', status: 'completed', size: '2.4 MB' },
    { id: 2, name: 'Staff Performance Review', type: 'Performance Report', date: '2024-01-10', status: 'completed', size: '1.8 MB' },
    { id: 3, name: 'Training Compliance', type: 'Compliance Report', date: '2024-01-08', status: 'completed', size: '3.2 MB' },
    { id: 4, name: 'Recruitment Analytics', type: 'Recruitment Report', date: '2024-01-05', status: 'completed', size: '4.1 MB' }
  ];
      ...
      <div className="flex-1 flex flex-col ml-64">
        <header className="bg-white shadow-sm border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 font-[family-name:var(--font-adlam-display)]">HR Reports</h1>
              <p className="text-gray-600 mt-1 font-[family-name:var(--font-adlam-display)]">Generate and manage HR reports</p>
            </div>

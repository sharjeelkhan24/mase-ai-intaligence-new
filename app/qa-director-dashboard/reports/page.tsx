...
export default function QAReportsPage() {
  ...
  const reports = [
    { id: 1, name: 'Quality Metrics Summary', type: 'Quality Report', date: '2024-01-15', status: 'completed', size: '2.4 MB' },
    { id: 2, name: 'Compliance Audit Report', type: 'Compliance Report', date: '2024-01-10', status: 'completed', size: '1.8 MB' },
    { id: 3, name: 'Patient Safety Analysis', type: 'Safety Report', date: '2024-01-08', status: 'completed', size: '3.2 MB' },
    { id: 4, name: 'Staff Training Progress', type: 'Training Report', date: '2024-01-05', status: 'completed', size: '4.1 MB' }
  ];
      ...
      <div className="flex-1 flex flex-col ml-64">
        <header className="bg-white shadow-sm border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 font-[family-name:var(--font-adlam-display)]">QA Reports</h1>

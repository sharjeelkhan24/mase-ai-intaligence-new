...
export default function SurveyReportsPage() {
  ...
  const reportStats = [
    { metric: 'Total Reports', value: '36', change: '+5', color: 'text-blue-600' },
    { metric: 'Generated This Month', value: '8', change: '+2', color: 'text-green-600' },
    { metric: 'Scheduled Reports', value: '12', change: '+3', color: 'text-purple-600' },
    { metric: 'Pending Approval', value: '4', change: '-1', color: 'text-yellow-600' }
  ];

  const reports = [
    { id: 1, title: 'Monthly Survey Summary Report', type: 'Summary', status: 'completed', generatedDate: '2024-01-15', period: 'December 2023', size: '2.1 MB' },
    { id: 2, title: 'Patient Satisfaction Analysis', type: 'Analysis', status: 'completed', generatedDate: '2024-01-14', period: 'Q4 2023', size: '1.8 MB' },
    { id: 3, title: 'Staff Performance Report', type: 'Performance', status: 'pending', generatedDate: '2024-01-16', period: 'January 2024', size: '0 MB' },
    { id: 4, title: 'Quality Metrics Dashboard', type: 'Dashboard', status: 'completed', generatedDate: '2024-01-12', period: 'December 2023', size: '3.2 MB' }
  ];

  const recentActivities = [
    { id: 1, activity: 'Monthly Survey Summary Report generated', date: '2024-01-15', user: 'System', report: 'Monthly Survey Summary Report' },
    { id: 2, activity: 'Patient Satisfaction Analysis completed', date: '2024-01-14', user: 'System', report: 'Patient Satisfaction Analysis' },
    { id: 3, activity: 'Staff Performance Report scheduled', date: '2024-01-13', user: 'System', report: 'Staff Performance Report' },
    { id: 4, activity: 'Quality Metrics Dashboard approved', date: '2024-01-12', user: 'System', report: 'Quality Metrics Dashboard' }
  ];
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1 font-[family-name:var(--font-adlam-display)]">Generate and manage survey reports</p>
            </div>
                    ...
                    <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{activity.report} • By {activity.user} • {new Date(activity.date).toLocaleDateString()}</p>
                        </div>
                      </div>
                      <button className="text-blue-600 hover:text-blue-900">
                        <Eye className="w-4 h-4" />

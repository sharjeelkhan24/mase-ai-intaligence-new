...
interface QADirectorNavbarProps {
  activeTab: string;
}

export default function QADirectorNavbar({ activeTab }: QADirectorNavbarProps) {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, href: '/qa-director-dashboard' },
    { id: 'quality-metrics', label: 'Quality Metrics', icon: TrendingUp, href: '/qa-director-dashboard/quality-metrics' },
    { id: 'compliance', label: 'Compliance', icon: Shield, href: '/qa-director-dashboard/compliance' },
    { id: 'audits', label: 'Audits', icon: Search, href: '/qa-director-dashboard/audits' },
    { id: 'reports', label: 'Reports', icon: FileText, href: '/qa-director-dashboard/reports' },
    { id: 'staff-training', label: 'Staff Training', icon: GraduationCap, href: '/qa-director-dashboard/staff-training' },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/qa-director-dashboard/settings' },
  ];

...
interface MarketingManagerNavbarProps {
  activeTab: string;
}

export default function MarketingManagerNavbar({ activeTab }: MarketingManagerNavbarProps) {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, href: '/marketing-manager-dashboard' },
    { id: 'campaigns', label: 'Campaigns', icon: Megaphone, href: '/marketing-manager-dashboard/campaigns' },
    { id: 'patient-feedback', label: 'Patient Feedback', icon: MessageSquare, href: '/marketing-manager-dashboard/patient-feedback' },
    { id: 'brand-management', label: 'Brand Management', icon: Palette, href: '/marketing-manager-dashboard/brand-management' },
    { id: 'analytics', label: 'Analytics', icon: TrendingUp, href: '/marketing-manager-dashboard/analytics' },
    { id: 'reports', label: 'Reports', icon: FileText, href: '/marketing-manager-dashboard/reports' },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/marketing-manager-dashboard/settings' },
  ];

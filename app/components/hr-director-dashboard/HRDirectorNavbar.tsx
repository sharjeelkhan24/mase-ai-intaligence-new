...
interface HRDirectorNavbarProps {
  activeTab: string;
}

export default function HRDirectorNavbar({ activeTab }: HRDirectorNavbarProps) {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, href: '/hr-director-dashboard' },
    { id: 'staff-management', label: 'Staff Management', icon: Users, href: '/hr-director-dashboard/staff-management' },
    { id: 'recruitment', label: 'Recruitment', icon: UserPlus, href: '/hr-director-dashboard/recruitment' },
    { id: 'performance', label: 'Performance', icon: TrendingUp, href: '/hr-director-dashboard/performance' },
    { id: 'training', label: 'Training', icon: GraduationCap, href: '/hr-director-dashboard/training' },
    { id: 'compliance', label: 'Compliance', icon: Shield, href: '/hr-director-dashboard/compliance' },
    { id: 'reports', label: 'Reports', icon: FileText, href: '/hr-director-dashboard/reports' },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/hr-director-dashboard/settings' },
  ];

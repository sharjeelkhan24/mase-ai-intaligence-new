...
interface HRSpecialistNavbarProps {
  activeTab: string;
}

export default function HRSpecialistNavbar({ activeTab }: HRSpecialistNavbarProps) {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, href: '/hr-specialist-dashboard' },
    { id: 'staff-records', label: 'Staff Records', icon: Users, href: '/hr-specialist-dashboard/staff-records' },
    { id: 'recruitment', label: 'Recruitment', icon: UserPlus, href: '/hr-specialist-dashboard/recruitment' },
    { id: 'onboarding', label: 'Onboarding', icon: GraduationCap, href: '/hr-specialist-dashboard/onboarding' },
    { id: 'benefits', label: 'Benefits', icon: Gift, href: '/hr-specialist-dashboard/benefits' },
    { id: 'compliance', label: 'Compliance', icon: Shield, href: '/hr-specialist-dashboard/compliance' },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/hr-specialist-dashboard/settings' },
  ];

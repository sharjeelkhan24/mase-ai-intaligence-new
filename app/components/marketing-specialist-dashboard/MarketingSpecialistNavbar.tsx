...
interface MarketingSpecialistNavbarProps {
  activeTab: string;
}

export default function MarketingSpecialistNavbar({ activeTab }: MarketingSpecialistNavbarProps) {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, href: '/marketing-specialist-dashboard' },
    { id: 'content-creation', label: 'Content Creation', icon: PenTool, href: '/marketing-specialist-dashboard/content-creation' },
    { id: 'social-media', label: 'Social Media', icon: Share2, href: '/marketing-specialist-dashboard/social-media' },
    { id: 'patient-outreach', label: 'Patient Outreach', icon: Users, href: '/marketing-specialist-dashboard/patient-outreach' },
    { id: 'analytics', label: 'Analytics', icon: TrendingUp, href: '/marketing-specialist-dashboard/analytics' },
    { id: 'reports', label: 'Reports', icon: FileText, href: '/marketing-specialist-dashboard/reports' },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/marketing-specialist-dashboard/settings' },
  ];
        ...
        <div className="flex flex-col items-center text-center p-4 rounded-lg bg-gray-50 mb-3 space-y-2">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-gray-500 font-[family-name:var(--font-adlam-display)]">
              {userInfo?.role || 'Marketing Specialist'}
            </p>
          </div>
        </div>

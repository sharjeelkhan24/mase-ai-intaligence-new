...
interface SurveyUserNavbarProps {
  activeTab: string;
}

export default function SurveyUserNavbar({ activeTab }: SurveyUserNavbarProps) {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, href: '/survey-user-dashboard' },
    { id: 'surveys', label: 'Surveys', icon: ClipboardList, href: '/survey-user-dashboard/surveys' },
    { id: 'data-collection', label: 'Data Collection', icon: Database, href: '/survey-user-dashboard/data-collection' },
    { id: 'reports', label: 'Reports', icon: FileText, href: '/survey-user-dashboard/reports' },
    { id: 'analytics', label: 'Analytics', icon: TrendingUp, href: '/survey-user-dashboard/analytics' },
    { id: 'settings', label: 'Settings', icon: Settings, href: '/survey-user-dashboard/settings' },
  ];

-- =====================================================
-- FINAL PATIENTS TABLE UPDATE
-- =====================================================
-- This script updates the patients table to match the HR management form
-- and fix patient signin issues
-- =====================================================
...
-- Add missing columns that are needed for full functionality
...
COMMENT ON TABLE patients IS 'Patients table for Patient role (compatible with HR form and patient signin)';

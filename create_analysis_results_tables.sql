...
-- These tables will store QA Review, Coding Review, and Financial Optimization results

-- QA Review Results Table
CREATE TABLE public.qa_review_results (
...
-- Coding Review Results Table
CREATE TABLE public.coding_review_results (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  agency_id uuid NOT NULL,
  analysis_id character varying(255) NOT NULL,
  file_name character varying(255) NOT NULL,
...
-- Financial Optimization Results Table
CREATE TABLE public.financial_optimization_results (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  agency_id uuid NOT NULL,
  analysis_id character varying(255) NOT NULL,
  file_name character varying(255) NOT NULL,
